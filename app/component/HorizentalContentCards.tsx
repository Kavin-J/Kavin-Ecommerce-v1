...
function HorizentalContentCards({
  src,
  padding = false,
  rounded = "none",
  shadow = "md",
  ...
  return (
    <div
      className={clsx(
        `min-w-[500px] h-[306px]`,
        `${isSmall ? "max-w-[620px]" : "max-w-[768px]"}`,
        `shadow-${shadow}`,
        `rounded-${rounded}`,
    ...
    >
      <div className="flex h-full w-full flex-row">
        {/* picture */}
        <div className={clsx("w-2/5 shrink-0", padding && "p-6")}>
          <div className={`relative h-full w-full rounded-t-${rounded} overflow-hidden`}>
            <Image
              className={clsx(
        ...
        {/* end Picture */}
        {/* Frame content */}
        <div className="h-full w-full space-y-3 p-6 pb-9 ">
...
export default HorizentalContentCards;
