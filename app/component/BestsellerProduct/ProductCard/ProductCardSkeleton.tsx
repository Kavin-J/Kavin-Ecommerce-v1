...
export default function ProductCardSkeleton({}: Props) {
  return (
    <div className="flex h-[550px] w-full max-w-sm animate-pulse-scale-sm flex-col rounded-lg border border-gray-200 bg-white p-1 shadow hover:scale-[1.01] hover:animate-pulse-scale-sm dark:border-gray-700  dark:bg-gray-800 md:animate-none ">
      <div className="mb-4 flex h-2/3 w-full min-w-60 items-center justify-center rounded  bg-gray-300 dark:bg-gray-700 ">
        <svg
